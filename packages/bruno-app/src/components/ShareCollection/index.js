...
import { IconDownload, IconAlertTriangle, IconLoader2 } from '@tabler/icons';
    ...
    >
      <StyledWrapper className="flex flex-col h-full w-[500px]">
        <div className="space-y-2"> 
          ...
          <div className="flex flex-col border border-gray-200 dark:border-gray-600 rounded-lg transition-colors">
            {hasGrpcRequests && (
